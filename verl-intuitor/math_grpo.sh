...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.rollout.mix_lambda=1 \
    ...
    trainer.project_name=verl_grpo_test6.2_cof0.1_lamb1_0908 \
    trainer.experiment_name=math_grpo_test6.2_cof0.1_lamb1_0908 \
